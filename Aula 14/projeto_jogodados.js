...
var dado4 = Math.floor(Math.random() * 6) + 1;
 ...
 console.log("Bem-Vinda(o) ao Jogo de Dados. Venha se Divertir Nesse Jogo Emocionante!!!!");
console.log();

let rodadas = +prompt("Quantas rodadas você quer jogar? ");
var jogadores = +prompt("Quantos jogadores irão jogar contra você? ");
let jogadas = {};
// function sortfunction(a , b){
//     return (b.score - a.score) //faz com que o array seja ordenado numericamente e de ordem crescente.
//   }
//   console.log(score.sort(sortfunction));
